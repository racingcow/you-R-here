...
YouRHere.FilterableDemoListView = YouRHere.DemoListView.extend({ //Backbone.View.extend({
    ...
    clickEntityItem: function(e) {
        ...
        var demoItemTemplate = "<div class='<%= item.type %>-icon'></div><header><span class='projectName left'>[<%= item.project %>]</span>  <span class='small'>(<a href='<%= item.url %>' target='_new'><%= item.id %></a>)</span> <span class='statusName'><%= item.statusName %></span> <span class='assignedName pull-right'>[<%= item.demonstratorName %>]</span></header><div class='avatar pull-right'><img src='<%= item.avatarUrlLarge %>'></img></div><div class='priority'><%= item.priority %></div><section><span class='itemName'> <%= item.name %> </span></section>";
...
YouRHere.DemoItemView = Backbone.View.extend({
    ...
    render: function () {
        var demoItemTemplate = "<div class='<%= item.type %>-icon'></div><header><span class='projectName left'>[<%= item.project %>]</span>  <span class='small'>(<a href='<%= item.url %>' target='_new'><%= item.id %></a>)</span> <span class='statusName'><%= item.statusName %></span> <span class='assignedName pull-right'>[<%= item.demonstratorName %>]</span></header> <div class='avatar pull-right'><img src='<%= item.avatarUrl %>'></img></div> <div class='priority'><%= item.priority %></div><section><span class='itemName'> <%= item.name %> </span></section>";
...
YouRHere.DemoItemDetailView = Backbone.View.extend({
    ...
    render: function () {
        ...
        var demoItemTemplate = "<div class='<%= item.type %>-icon'></div><span class='projectName left'>[<%= item.project %>]</span>  <span class='small'>(<a href='<%= item.url %>' target='_new'><%= item.id %></a>)</span> <span class='statusName'><%= item.statusName %></span> <span class='assignedName right'>[<%= item.demonstratorName %>]</span>  <div class='avatar pull-right'><img src='<%= item.avatarUrlLarge %>'></img></div> <div class='priority'><%= item.priority %></div><section><span class='itemName'> <%= item.name %> </span></section>";
